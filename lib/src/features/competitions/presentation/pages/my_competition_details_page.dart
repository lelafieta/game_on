...
class MyCompetitionsDetailsPage extends StatefulWidget {
  const MyCompetitionsDetailsPage({super.key});

  @override
  State<MyCompetitionsDetailsPage> createState() =>
      _MyCompetitionsDetailsPageState();
}

class _MyCompetitionsDetailsPageState extends State<MyCompetitionsDetailsPage>
